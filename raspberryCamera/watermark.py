...
class Watermark():
    ...
    def setParams(self, params):
        ...
        if params['FONT'] is not None:
            self.FONT = params['FONT']

    # INICIALIZACION LINEAL DE VARIABLES
    def setParamsLineal(self, logoPath, imagePath, output, title, style, font=None, fontsize=12, sizeLogo=80):
    ...
    def maketitle(self,  date='', typePos=1):
        ...
        if typePos == 1:
            ...
            posText1 = (10, 1)
            posText2 = (width - (fontSize * 10 + 40), 1)
        # ---------------------------------------
    ...
    def makeWatermark(self, date=''):
        ...
        if self.style == 1:
            ...
            self.makelogo(sizeLogo=self.sizeLogo, typePos=3)
        elif self.style == 4:
            self.makereactangule(rheight=22, typePos=2)
            self.maketitle(date=date, typePos=3)
            self.makelogo(sizeLogo=self.sizeLogo, typePos=3)
